defmodule SavvyFlags.Accounts do
  @moduledoc """
  ...
  def update_user(user, attrs) do
    ...
    |> Ecto.Changeset.put_assoc(:environments, environments)
    |> Repo.update()
  end
  ...
  def list_users do
    query =
      from u in User,
        ...
        preload: [:projects, :features, :environments]
  ...
  """
  def get_user!(reference), do: Repo.get!(User, reference)
  ...
  def update_user_mfa(user, secret, recovery_codes) do
    user
    |> User.mfa_changeset(secret, recovery_codes)
    |> Repo.update()
  end
  ...
  @doc """
  Preload environments, projects and features for the current user.
  """
  def preload_current_user(nil) do
    nil
  end

  def preload_current_user(user) do
    Repo.preload(user, [:environments, :projects, :features])
  end
  ...
  def mfa_enabled?(user), do: not is_nil(user.secret)
end
