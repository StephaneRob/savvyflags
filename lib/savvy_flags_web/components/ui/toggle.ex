defmodule SavvyFlagsWeb.UI.Toggle do
  ...
  def toggle(assigns) do
    ...
    <label class="relative inline-flex items-center cursor-pointer text-zinc-800">
      ...
      <div class="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-neutral-300 rounded-lg peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-lg after:h-4 after:w-4 after:transition-all  peer-checked:bg-emerald-400">
      </div>
